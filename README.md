This is the program for: Subnational Contributions to Population Ageing: Insights from Australia
...
Data use: Users of the data must cite the ABS and comply with terms of use. 
Program use: Users are free to use and share the program with acknowledgement of the author. 
